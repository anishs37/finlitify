...
import saveQuestions from './saveQuestions'; // Assuming you have a file named 'saveQuestions.js'
...
const MenuPage1 = () => {
  ...
  const handleNextQuestion = () => {
    ...
    if (level) {
      const levelQuestions = Object.values(saveQuestions).filter((q) => q.level === level && q.key !== currentQuestion.key);
